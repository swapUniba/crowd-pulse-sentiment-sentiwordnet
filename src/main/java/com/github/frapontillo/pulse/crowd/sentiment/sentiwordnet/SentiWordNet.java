...
public class SentiWordNet {
    ...
    public double getWeightedScore(String synset, double nounFactor, double verbFactor,
                                   double adjectiveFactor, double adverbFactor) {
    ...
    public double getWeightedScore(String[] synsets, double nounFactor, double verbFactor,
                                   double adjectiveFactor, double adverbFactor) {
        ...
        for (String synset : synsets) {
            totalScore +=
                    getWeightedScore(synset, nounFactor, verbFactor, adjectiveFactor, adverbFactor);
        }
